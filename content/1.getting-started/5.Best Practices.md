...
description: Learn how to build production-ready AI agents with Verly.
navigation:
  icon: i-lucide-star
---

Building an effective AI agent requires a shift in mindset from traditional chatbot design. Follow these best practices to get the most out of Verly.
...
::prose-success
**Better:** "You are Vera, a friendly support specialist at Verly. Your job is to help users configure their AI agents, resolve billing issues, and escalate complex technical problems to the engineering team."
::
...
Verly lets you choose the underlying language model that powers your agent. Picking the right model directly impacts response quality, speed, and cost.
...
Verly gives you full control over how your agent looks, sounds, and behaves across channels.
...
Verly uses a **Unified Agent State**. Configure your knowledge base and tools once — then deploy to Web, WhatsApp, or Voice instantly.
...
Verly offers native integrations (e.g., Shopify, Zendesk, Calendly) that are pre-configured and tested. Prefer these over building custom webhooks for common use cases.
...
- Use a **secret header** or **HMAC signature** to verify that webhook calls originate from Verly.
